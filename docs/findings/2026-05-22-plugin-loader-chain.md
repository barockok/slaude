...
```json
{ "plugins": [{ "marketplace": "git@bitbucket.org:acme/openskill.git",
...
connected (verified in staging maria).
...
- install the toolchain in the deploy Dockerfile (we already do
