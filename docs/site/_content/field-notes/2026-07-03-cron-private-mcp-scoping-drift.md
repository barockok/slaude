...
see 2026-07-03-cron-oauth-user-null-fallback.md
and 2026-07-03-cron-private-mcp-no-oauth.md).
...
([src/gateway/core/gateway.ts:334-335](https://github.com/barockok/slaude/blob/main/src/gateway/core/gateway.ts#L334-L335)):
...
config-dir path, [src/gateway/slack/cron-scheduler.ts:76](https://github.com/barockok/slaude/blob/main/src/gateway/slack/cron-scheduler.ts#L76)).
...
- **Channel-target jobs.** Session key is always the synthetic `cron:<id>`
  ([cron-scheduler.ts:62-63](https://github.com/barockok/slaude/blob/main/src/gateway/slack/cron-scheduler.ts#L62-L63)).
...
- **Thread-target jobs.** Session key is the real `slackThreadTs`
  ([cron-scheduler.ts:63](https://github.com/barockok/slaude/blob/main/src/gateway/slack/cron-scheduler.ts#L63)). Here
...
[src/agent/manager.ts:169](https://github.com/barockok/slaude/blob/main/src/agent/manager.ts#L169) /
[src/agent/manager.ts:400-402](https://github.com/barockok/slaude/blob/main/src/agent/manager.ts#L400-L402)) instead of
