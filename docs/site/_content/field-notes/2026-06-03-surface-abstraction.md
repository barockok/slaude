...
Implements [the surface-abstraction spec](https://github.com/barockok/slaude/blob/main/docs/internal/superpowers/specs/2026-06-03-surface-abstraction-design.md).
