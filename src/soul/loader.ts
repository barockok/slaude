...
(\`U06ENBS6PV0\`) or mention syntax (\`<@U06ENBS6PV0>\`); separators may
 ...
 *        - code:     barock => U06ENBS6PV0   ; comments after ; ignored
 *
 *    The line "<category>: <ids…>" form. IDs may be raw Slack user IDs
 *    (e.g. U06ENBS6PV0) or mention syntax (<@U06ENBS6PV0>). Comma,
 ...
 *
 *        \`\`\`approvers
 *        { "default": ["U06ENBS6PV0"], "database": ["U999"] }
 *        \`\`\`
 *
