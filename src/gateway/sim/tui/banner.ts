...
// The logo asset, parsed once at module load. We use the downscaled 15×6 variant (generated by
// assets/gen-small-logo.ts from amartha-logo.ansi) so it matches the height of the "A-Claw"
// wordmark beside it. Trailing newline trimmed so it doesn't add a blank row.
