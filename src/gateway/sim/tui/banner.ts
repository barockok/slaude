...
// The logo asset, parsed once at module load. amartha-logo-small.ansi is generated crisp from the
// hi-res source PNG by assets/gen-logo.py (20×8) — regenerate with a different width to resize.
// Trailing newline trimmed so it doesn't add a blank row.
const logoAnsi = readFileSync(join(import.meta.dir, "assets", "amartha-logo-small.ansi"), "utf8").replace(/\n$/, "");
