...
// The logo asset, parsed once at module load. logo-small.ansi is generated crisp from the
...
const logoAnsi = readFileSync(join(import.meta.dir, "assets", "logo-small.ansi"), "utf8").replace(/\n$/, "");
