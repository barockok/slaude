...
- [2026-09-06 — Folks rebrand: a marketing-only name over slaude (code, CLI, `SLAUDE_*` unchanged); the Folk character (thread-bubble head, no mouth because the tail is the voice), four persona eye/colour sets on one silhouette, and three particle scenes (assembly, roll-call, fleet) under `docs/site/folks/`](docs/site/_content/field-notes/2026-09-06-folks-rebrand.md)
