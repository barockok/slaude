...
- [2026-08-27 — Cron mixed root + thread output: channel-target jobs had one fixed root destination, so `reply` now accepts a prior reply's `ref` as `thread_ref` for follow-up details](docs/findings/2026-08-27-cron-mixed-root-thread-output.md)
